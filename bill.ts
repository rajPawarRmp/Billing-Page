var s: HTMLSelectElement = <HTMLSelectElement>document.getElementById("sel")
var matter: { val: number, item: string, rate: number }[] = []            //initilising empty object
var dis: HTMLInputElement = <HTMLInputElement>document.getElementById("display")
var fin: HTMLInputElement = <HTMLInputElement>document.getElementById("final")
var sum = 0
...
for (let i = 0; i < 14; i++) {
	...
	var opt: HTMLOptionElement = <HTMLOptionElement>document.createElement("option") // inserting option
...
function bill() {
	var inp: HTMLInputElement = <HTMLInputElement>document.getElementById("inp") //this is quantity of items
	var inip = parseInt(inp.value)

	var choice: HTMLSelectElement = <HTMLSelectElement>document.getElementById("sel")
...
function cle() { //function for clearing bill display and for taking new values
